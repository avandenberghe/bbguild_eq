 ...
 *
 * Canonical version lives in ext::BBGUILDEQ_VERSION; not in phpbb_config.
 */
...
class release_2_0_0_a1 extends \phpbb\db\migration\migration
{
	...
	{
		// Version lives in ext::BBGUILDEQ_VERSION, not phpbb_config;
		...
		$sql = 'SELECT COUNT(*) AS cnt FROM ' . $games_table . " WHERE game_id = 'eq'";
